    ...
    <div className={styles.container}>
      ...
      >
        <Descriptions bordered>
          ...
          <Descriptions.Item label="支付方式"><Tag>{orderDetails?.pay_method == 'Manual' ? '后台充值' : '微信支付'}</Tag></Descriptions.Item>
          <Descriptions.Item label="状态">
            <Tag color={color}>{statusText}</Tag>
          </Descriptions.Item>
          <Descriptions.Item label="金额">¥{orderDetails?.amount / 1000000}</Descriptions.Item>
